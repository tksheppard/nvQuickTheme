...
<main>
  ...
  <div class="container">
    <div class="row">
      <div id="DoublePaneOneOne" class="col-md-6" runat="server"></div>
      <div id="DoublePaneOneTwo" class="col-md-6 bg-light-shade" runat="server"></div>
    </div>
  </div>   

  <div class="container-fluid bg-dark-shade">
    <div class="container">
